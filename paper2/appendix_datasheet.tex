...
%  Gebru et al. (2021) Datasheets for Datasets framework
%  \input'd from main.tex after \appendix command
% ============================================================
...
(Section~\ref{ssec:splits} of the main paper) so that no real image and its six AI
...
canonical preprocessing) to BLIP-2 (\pathtt{Salesforce/blip2-opt-2.7b})
